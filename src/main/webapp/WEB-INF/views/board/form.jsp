...
<article>
    ...
    <form action="${pageContext.request.contextPath}/board" method="post">
        ...
        <input type="text" id="subject" name="subject" value="${article != null ? article.subject : ''}" placeholder="제목을 입력하세요" required>

        <label for="content">내용</label>
        <textarea id="content" name="content" rows="10" placeholder="내용을 입력하세요" required>${article != null ? article.content : ''}</textarea>
